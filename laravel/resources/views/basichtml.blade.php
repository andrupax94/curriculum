...
<body ng-controller="body" class="customS">
    ...
    <div class="lang__container" ng-click='animaFlag()'>
        <div class="lang__flag" >
            <div class="flag" ng-click='cambiaLang($event,"es")' ng-class="{'firstFlag':lang==='es-ES'}" style='background-image:url("/image/spainFlag.svg")'></div>
            <div class="flag" ng-click='cambiaLang($event,"en")' ng-class="{'firstFlag':lang==='en-EN'}" style='background-image:url("/image/UKFlag.svg")'></div>
        </div>
